...
{
  options: rule: start: ini
  options: rule: exclude: jsonic
  options: lex: emptyResult: {}
  options: fixed: token: '#EQ': '='
  options: fixed: token: '#DOT': '.'
  options: fixed: token: '#OB': null
  options: fixed: token: '#CB': null
  options: fixed: token: '#CL': null
  options: line: check: '@line-check'
  options: number: lex: false
  options: string: lex: true
  options: string: chars: QUOTE_CHARS
  options: string: abandon: true
  options: text: lex: false
  options: comment: def: hash: eatline: true
  options: comment: def: slash: null
  options: comment: def: multi: null
  options: comment: def: semi: line: true
  options: comment: def: semi: start: ';'
  options: comment: def: semi: lex: true
